...
High-performance limit order book implementation supporting order matching, inserts, and cancellations.
Focus on efficient data structures and low-latency updates similar to real exchange matching engines.
